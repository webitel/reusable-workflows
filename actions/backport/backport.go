...
type BackportOpts struct {
	...
	// Kept for backward compatibility and for use in messages. When SourceSHAs is provided,
	// cherry-picking will process all SHAs in SourceSHAs sequentially.
	SourceSHA string

	// SourceSHAs is an ordered list (oldest to newest) of commit hashes to cherry-pick
	SourceSHAs []string
